...
I am Vishnu I have completed UG degree as a Bachelor of Engineering at Anna university in "SIET" in the stream of "EEE" in the year of
2019. After completion of my degree i got a oppurtunity to collobrate with the Aquasub Engineering its a motor & pump
industry. I have 2 years and 8 months of experience in that company as a Testing Engineer. After my contract period has 
over i like to join in the CRI Pumps its also a motor & pump industry am working in as a Testing Engineer. After that Lakshmi 
motors for few months in the Marketing and Service field.

On that time i got a chance to attend the workshop about the web development & i really like to learn these web development course
so i decide to upgrade my skills & took a oppurtunity to change my carrier path to IT field for my future growth potential 
to build my career & facing new challenges then i get to know about the Guvi platform. Now i am currently pursuing my 
...
my strength i look my self as a hardworking guy, self motivated, problem solving with good communucation, Quick leaner &
moreover that i daily practicing my skills to keep me in update.

my weekness as I will concentrate 1 thing at a time, too detailed oriented & self criticism.
...
columns divide the container into 12 equal parts using CSS Grid.

-- FLEX
Flexbox is primarily used for one-dimensional layouts, such as arranging items in a row or column.
It is ideal for creating layouts that need to be flexible and responsive, such as navigation menus or flexible forms.
